...
# Retrieve specific environment variables for username , assistantname , API key.
...
*** Reply in only English, even if the question is in Hindi, reply in Hindi. If the question is in English then reply in English.***
...
def Chatbot(Query):
    ...
    try:
        ...
        # Process the streamed respone chunks.
